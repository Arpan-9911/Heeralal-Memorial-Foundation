...
const legacyData = {
  title: {
    en: "Our Institutional Roots",
    hi: "हमारी संस्थागत जड़ें",
  },
  paragraphs: [
    {
...
const visionData = {
  ...
  objective: {
    title: { en: "Core Objective", hi: "मूल उद्देश्य" },
    desc: {
...
const coreValues = [
  {
    icon: "🏛️",
    title: { en: "Integrity", hi: "सत्यनिष्ठा" },
    desc: {
      en: "Upholding the highest standards of transparency in every transaction and initiative.",
      hi: "हर लेनदेन और पहल में पारदर्शिता के उच्चतम मानकों को बनाए रखना।",
    },
  },
  {
    icon: "✊",
    title: { en: "Empowerment", hi: "सशक्तिकरण" },
    desc: {
      en: "Moving beyond charity to build enduring self-reliance and dignity.",
      hi: "दान से आगे बढ़कर स्थायी आत्मनिर्भरता और गरिमा का निर्माण।",
    },
  },
  {
    icon: "🤝",
    title: { en: "Inclusivity", hi: "समावेशिता" },
    desc: {
      en: "Ensuring no individual is left behind regardless of caste, creed, or gender.",
      hi: "जाति, पंथ या लिंग की परवाह किए बिना किसी भी व्यक्ति को पीछे न छोड़ना।",
    },
  },
  {
    icon: "📊",
    title: { en: "Efficiency", hi: "दक्षता" },
    desc: {
      en: "Maximizing the impact of every rupee through institutional rigor.",
      hi: "संस्थागत कठोरता के माध्यम से हर रुपये के प्रभाव को अधिकतम करना।",
    },
  },
];
...
const governanceData = {
  ...
  rows: [
    {
      body: { en: "Board of Trustees", hi: "न्यासी बोर्ड" },
      frequency: { en: "Quarterly", hi: "त्रैमासिक" },
      responsibility: {
        en: "Strategic Direction & Fiduciary Oversight",
        hi: "रणनीतिक दिशा और न्यासी निरीक्षण",
      },
    },
    {
      body: { en: "Executive Committee", hi: "कार्यकारी समिति" },
      frequency: { en: "Monthly", hi: "मासिक" },
      responsibility: {
        en: "Operational Execution & Program Management",
        hi: "परिचालन निष्पादन और कार्यक्रम प्रबंधन",
      },
    },
    {
      body: { en: "Audit Committee", hi: "ऑडिट समिति" },
      frequency: { en: "Bi-Annual", hi: "अर्धवार्षिक" },
      responsibility: {
        en: "Financial Integrity & Compliance Review",
        hi: "वित्तीय अखंडता और अनुपालन समीक्षा",
      },
    },
  ],
};
...
const complianceData = {
  ...
  cards: [
    {
      title: { en: "Transparency Pledge", hi: "पारदर्शिता प्रतिज्ञा" },
      desc: {
        en: "Our annual financial reports are subjected to independent third-party audits to maintain the highest level of trust with our stakeholders and donors.",
        hi: "हमारी वार्षिक वित्तीय रिपोर्टें स्वतंत्र तृतीय-पक्ष ऑडिट के अधीन हैं ताकि हमारे हितधारकों और दाताओं के साथ उच्चतम स्तर का विश्वास बनाए रखा जा सके।",
      },
    },
    {
      title: { en: "Ethics Hotline", hi: "नैतिकता हॉटलाइन" },
      desc: {
        en: "We maintain a dedicated compliance cell for whistleblowing and ethical grievances to ensure zero tolerance for mismanagement.",
        hi: "हम कुप्रबंधन के लिए शून्य सहिष्णुता सुनिश्चित करने के लिए व्हिसलब्लोइंग और नैतिक शिकायतों के लिए एक समर्पित अनुपालन सेल बनाए रखते हैं।",
      },
    },
  ],
};
...
const Watermark = () => (
  <div className="absolute top-4 right-4 opacity-[0.06] pointer-events-none select-none">
    <div className="w-28 h-28 rounded-full bg-[var(--color-secondary)]" />
  </div>
);
...
const InstitutionalLegacy = () => {
  ...
  return (
    <div className="relative bg-white rounded-lg shadow-sm border border-gray-100 p-6 md:p-10">
      ...
      >
        {legacyData.title[lang]}
      </h2>

      <div className="space-y-4 mb-8">
        {legacyData.paragraphs.map((p, i) => (
    ...
    <div className="relative bg-white rounded-lg shadow-sm border border-gray-100 p-6 md:p-10">
      ...
      <div className="relative rounded-lg overflow-hidden bg-[image:var(--gradient-secondary)] p-8 md:p-12 mb-8">
        ...
        <div className="absolute inset-0 opacity-10">
          <img
            src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=1972"
            alt=""
        ...
        <div className="relative z-10">
          <p className="text-[var(--color-primary)] text-xs uppercase tracking-widest font-bold mb-2">
            {visionData.subtitle[lang]}
          </p>
          <h2 className="text-white text-2xl md:text-3xl font-bold mb-4">
            {visionData.title[lang]}
          </h2>
          <p
            className="text-gray-200 italic text-sm md:text-base leading-relaxed max-w-3xl"
            style={{ fontFamily: "'Georgia', serif" }}
          >
            {visionData.quote[lang]}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {[visionData.mission, visionData.objective].map((item, i) => (
          <div
            key={i}
            className="border-l-4 border-[var(--color-primary)] pl-5 py-2"
          >
    ...
    <div className="relative bg-white rounded-lg shadow-sm border border-gray-100 p-6 md:p-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {coreValues.map((item, i) => (
          <div
            key={i}
            className="flex items-start gap-4 p-5 rounded-lg border border-gray-100 bg-[var(--color-bg)] hover:shadow-md transition-shadow duration-300"
          >
            <div className="text-3xl flex-shrink-0 w-12 h-12 rounded-full bg-[var(--color-primary-light)] flex items-center justify-center">
              {item.icon}
            </div>
            <div>
              <h3 className="text-sm font-bold text-[var(--color-secondary)] mb-1">
                {item.title[lang]}
              </h3>
  ...
  return (
    <div className="relative bg-white rounded-lg shadow-sm border border-gray-100 p-6 md:p-10">
      ...
      <h2
        ...
        style={{ fontFamily: "'Georgia', serif" }}
      >
        {governanceData.title[lang]}
      </h2>
      <p className="text-sm text-gray-700 leading-relaxed mb-8">
        {governanceData.description[lang]}
      </p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-[var(--color-secondary)] text-white">
              {governanceData.headers[lang].map((h, i) => (
                <th
                  key={i}
                  className="text-left text-xs uppercase tracking-wider font-semibold px-5 py-3"
                >
                  {h}
                </th>
              ))}
    ...
    <div className="relative bg-white rounded-lg shadow-sm border border-gray-100 p-6 md:p-10">
      ...
      <div className="border-l-4 border-[var(--color-primary)] pl-5 mb-6">
        <h2
          ...
          style={{ fontFamily: "'Georgia', serif" }}
        >
          {complianceData.title[lang]}
        </h2>
      </div>

      <p className="text-sm text-gray-700 leading-relaxed mb-6">
        {complianceData.description[lang]}
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        {complianceData.items.map((item, i) => (
          <div
            key={i}
            className="flex items-center gap-3 px-5 py-3 rounded border border-gray-100 bg-[var(--color-bg)]"
          >
      ...
      {/* Transparency + Ethics Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {complianceData.cards.map((card, i) => (
          <div
            key={i}
            className="border border-gray-100 rounded-lg p-5 hover:shadow-md transition-shadow duration-300"
          >
