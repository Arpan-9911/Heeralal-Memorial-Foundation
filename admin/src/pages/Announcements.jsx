  ...
  const handleSave = async () => {
    try {
      ...
      const payload = {
        ...
        excerptEn: form.excerpt.en,

        excerptHi: form.excerpt.hi,
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mb-4">
                  <h2 className="text-lg font-bold">{item.title?.en}</h2>

                  <p className="text-sm text-gray-600">{item.excerpt?.en}</p>
                </div>

                {/* HINDI */}

                <div className="mt-1">
                  <h3 className="font-semibold">{item.title?.hi}</h3>

                  <p className="text-sm text-gray-500">{item.excerpt?.hi}</p>
                </div>
              </div>
